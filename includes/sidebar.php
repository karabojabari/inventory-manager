...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(135deg, #07503bff 0%, #01241aff 100%) !important;">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3" style="font-size: 1.5rem; font-weight: bold;">IMS</div>
      </a>
    ...
    General
      ...
      <!-- Tables Buttons -->
      <li class="nav-item">
    <a class="nav-link" href="customer.php" style="color: white !important;">
        <i class="fas fa-fw fa-user" style="color: white !important;"></i>
        <span style="color: white !important;">Customer</span>
    </a>
</li>
    ...
    <a class="nav-link text-white" href="transaction.php">
        <i class="fas fa-fw fa-retweet text-white"></i>
