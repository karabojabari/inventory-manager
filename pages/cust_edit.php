  ...
  <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
    ...
    <div class="card-body">
      <form role="form" method="post" action="cust_edit1.php">
        ...
        <div class="form-group row text-left" style="color: #047857; text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">
...
<!-- Dark Green Back Button at Bottom with Shadow -->
<div class="container-fluid mt-4">
  <div class="row">
    <div class="col-md-12 text-center">
      <a href="customer.php" type="button" class="btn btn-primary" 
         style="background: linear-gradient(135deg, #047857 0%, #065f46 100%); 
                border-color: #047857; 
                color: white; 
                padding: 10px 30px;
